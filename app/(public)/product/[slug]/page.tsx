...
export default function ProductDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  // Zustand State
  const { setProduct, userId, setUserId, selectedNominalId, setNominal, selectedPaymentId, setPayment, reset } = useTopupStore();
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-card border rounded-2xl p-6 shadow-lg sticky top-24">
              <div className="w-32 h-32 rounded-2xl overflow-hidden bg-muted mb-4 shadow-md mx-auto lg:mx-0">
                <Image src={product.image} alt={product.name} width={128} height={128} className="object-cover w-full h-full" />
              </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-card border rounded-2xl p-6 shadow-sm">
              ...
              <PriceSelector nominals={product.nominals} selectedId={selectedNominalId} onSelect={setNominal} />
            </section>
            ...
            <section className="bg-card border rounded-2xl p-6 shadow-sm">
              ...
              <PaymentSelector selectedId={selectedPaymentId} onSelect={setPayment} />
            </section>
            ...
            <section className="bg-card border rounded-2xl p-6 shadow-sm">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-sm text-muted-foreground">Nomor ini akan digunakan untuk mengirim status transaksi.</p>
              </div>
            </section>
            ...
            <section className="bg-card border rounded-2xl p-6 shadow-sm sticky bottom-4 z-30 lg:static">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="text-sm text-muted-foreground hidden md:block">Pastikan data anda benar sebelum melanjutkan.</div>
